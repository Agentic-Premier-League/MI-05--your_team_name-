  ...
  return (
    ...
    >
      <div
        ...
        style={{ padding: "48px", maxWidth: "420px", width: "100%", textAlign: "center" }}
      >
        {/* Logo */}
        ...
        {error && (
          <div style={{ color: "var(--red)", fontSize: "14px", marginBottom: "16px", background: "rgba(239, 68, 68, 0.1)", padding: "12px", borderRadius: "8px", border: "1px solid rgba(239, 68, 68, 0.2)" }}>
            {error}
          </div>
        )}
        ...
        <button
          ...
          style={{ width: "100%", padding: "14px", fontSize: "15px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", opacity: isLoading ? 0.7 : 1 }}
